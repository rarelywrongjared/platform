...
// /**
//  * this is the encryption key used in drupal for user password encryption i.e.
//  * leave it in blank unless necessary
//  */
// $drupal_hash_salt = '';
...
//   //jquery update settings - force local copy usage to keep advagg aggressive
...
//   $conf['advagg_css_fix_type'] = 1;
//   $conf['advagg_css_remove_empty_files'] = 1;
//   $conf['advagg_js_fix_type'] = 1;
//   $conf['advagg_js_remove_empty_files'] = 1;
